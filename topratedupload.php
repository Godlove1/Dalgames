...
<head>
	...
	<title>Admin-Top rated games edit</title>
...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<fieldset>
			<legend>New Top Rated Game</legend>
			<!--name of the file-->
			...
			<!--/price-->
			<!--star rating-->
			<label for="price">Number of stars :</label>
			<input type="number" name="star" class="field" max="5" required><br>
			<!--/price-->
			<!--Console-->
...
<?php
include 'dbconn.php';
include 'topratedscript.php';
?>

<?php
$records = mysqli_query($conn, "select * from topratedgames");
