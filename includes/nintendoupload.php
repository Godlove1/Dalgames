...
if (isset($_POST["submit"])) {
	...
	$check = mysqli_query($conn, "insert into nintendo(filename,images,price,console) values('$_POST[name]','$dst_db','$_POST[price]','$_POST[console]')");
...
<head>
	...
	<title>Admin-Nintendo games edit</title>
...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<fieldset>
			<legend>Add New Nintendo Game</legend>
			<!--name of the file-->
