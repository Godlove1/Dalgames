...
//	$var3 = md5($var3);
	...
	$check = mysqli_query($conn, "insert into featgames(filename,images,price,console) values('$_POST[name]','$dst_db','$_POST[price]','$_POST[console]')");
...
<head>
	...
	<title>Admin-feaured games edit</title>
...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<fieldset>
			<legend>Add Featured Game</legend>
			<!--name of the file-->
