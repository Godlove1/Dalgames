...
if (isset($_POST["submit"])) {
	...
	$check = mysqli_query($conn, "insert into playstation(filename,images,price,console) values('$_POST[name]','$dst_db','$_POST[price]','$_POST[console]')");
...
<head>
	...
	<title>Admin-Playstation games edit</title>
...
<body>
	...
	<form method="post" enctype="multipart/form-data">
		<fieldset>
			<legend>Add New Playstation Game</legend>
			<!--name of the file-->
			...
			<input type="text" name="console" class="field"><br><br>
			<!--/console-->
			<!--Submit button-->
